...
# Este script despliega simultáneamente la API y el Dashboard en Google Cloud Run
...
echo "============================================="
echo " Despliegues de Servicios GCP Completados!!! "
echo "============================================="
